export const ROOMS = [
  { id: "ct1", name: "1F CT", sheetName: "Sheet A", icon: "radiology", accent: "#2563eb", items: ["Omnipaque", "Visipague320", "高壓注射器針筒"] },
  { id: "ct3", name: "3F CT", sheetName: "Sheet B", icon: "scanner", accent: "#0891b2", items: ["Omnipaque", "Visipague320", "高壓注射器針筒"] },
  { id: "rct", name: "RCT", sheetName: "Sheet C", icon: "monitor_heart", accent: "#7c3aed", items: ["Omnipaque", "Ultravist370", "Visipague320", "高壓注射器針筒"] },
  ...
  { id: "vascular", name: "血管", sheetName: "Sheet H", icon: "vascular", accent: "#dc2626", items: ["Omnipaque", "Ultravist370", "Visipague320", "高壓注射器針筒"] },
  ...
  { id: "syringe", name: "高壓注射器針筒", sheetName: "Sheet J", icon: "syringe", accent: "#0d9488", type: "syringe", items: ["高壓注射器針筒", "延長管", "三通閥"] }
];
