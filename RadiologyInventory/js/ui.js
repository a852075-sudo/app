...
import { syncEntry, fetchRoomEntries, appendReportRows } from "./sheet.js";
...
function buildReferenceEntries(room, config, data) {
  ...
  return config.groups
    .map((group) => {
      ...
      const hasInput = Object.values(values).some((value) => value !== null && value !== "");
      ...
      return {
        ...
        note,
        touched: {
          peopleQty: values.peopleQty !== null && values.peopleQty !== "",
          inQty: values.inQty !== null && values.inQty !== "",
          balanceQty: values.balanceQty !== null && values.balanceQty !== "",
          usedQty: values.usedQty !== null && values.usedQty !== "",
          note: note !== ""
        }
      };
    })
...
function buildGenericEntry(room, data) {
  return {
    ...
    note: data.get("note"),
    touched: {
      peopleQty: data.get("peopleQty") !== null && data.get("peopleQty") !== "",
      inQty: data.get("inQty") !== null && data.get("inQty") !== "",
      balanceQty: data.get("balanceQty") !== null && data.get("balanceQty") !== "",
      wasteQty: data.get("wasteQty") !== null && data.get("wasteQty") !== "",
      note: (data.get("note") || "") !== ""
    }
  };
}
