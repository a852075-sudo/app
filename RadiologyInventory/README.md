...
- 首頁 Material Design 3 icon 卡片：1F CT、3F CT、RCT、1F MRI、3F MRI、3T MRI、特殊、血管、IVP、總盤點彙整、高壓注射器針筒。
...
更新 `gas/Code.gs` 後，請到 Apps Script 的「部署」>「管理部署作業」建立新版本並重新部署。新版 API 另支援 `appendReport`，可將總盤點彙整與高壓注射器針筒的月份紀錄追加寫入 Google Sheets，保留舊月份資料。
